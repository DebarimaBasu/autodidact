...
//             <Trash2 className="min-w-4 min-h-4 text-green-500" />
//           </Button>
//         )}
//       </div>
...
const handleDelete = () => {
  // Check if initialData exists and contains an id
    ...
    (t) => (
      <div className="bg-white p-4 rounded-lg shadow-md text-center">
        ...
        <div className="flex gap-4 mt-2">
          <Button
            onClick={async () => {
              try {
                ...
                toast.success("Interview deleted successfully!"); // Success toast
                navigate("/generate", { replace: true }); // Navigate to another page after deletion
              } catch (error) {
                console.error(error); // Log any errors
                toast.error("Error deleting interview. Please try again."); // Error toast
              } finally {
          ...
          <Button
            onClick={() => toast.dismiss(t)} // Dismiss the toast without action
            size="sm"
            variant="outline"
